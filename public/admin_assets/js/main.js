...
tinymce.init({
    ...
    license_key: "gpl",
    plugins:
        "preview importcss searchreplace autolink autosave directionality code visualblocks visualchars fullscreen image link media codesample table charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount charmap quickbars emoticons accordion",
    editimage_cors_hosts: ["picsum.photos"],
    menubar: "file edit view insert format tools table ",
    toolbar:
        "undo redo | bold italic superscript subscript underline strikethrough blocks fontsizeinput fontfamily align numlist bullist | link image | forecolor backcolor removeformat | table media | lineheight outdent indent| charmap emoticons | print |code fullscreen preview |  pagebreak anchor codesample | accordion accordionremove | ltr rtl",
    ...
    quickbars_selection_toolbar:
        "bold italic | fontsizeinput | forecolor backcolor quicklink charmap emoticons h2 h3 align quickimage quicktable",
